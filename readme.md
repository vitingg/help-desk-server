...
=> rotas de patch e delete nos ticket do serviço que deverá ser feito pelo técnico
=> admin deve ter patch no clientes (deletar um cliente deleta todos os seus
